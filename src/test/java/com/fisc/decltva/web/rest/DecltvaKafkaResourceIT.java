package com.fisc.decltva.web.rest;

import com.fisc.decltva.DecltvaApp;
...
@SpringBootTest(classes = DecltvaApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DecltvaKafkaResourceIT {
    ...
    @Autowired
    private DecltvaKafkaProducer producer;

    @Autowired
    private DecltvaKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DecltvaKafkaResource kafkaResource = new DecltvaKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/decltva-kafka/publish?message=test"))
